        ...
        <div class="grid lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <a href="{{ route('projects.index') }}" class="bg-orange-50 hover:bg-orange-100 p-4 rounded-lg text-center transition">
                    ...
                    <a href="{{ route('clients.index') }}" class="bg-purple-50 hover:bg-purple-100 p-4 rounded-lg text-center transition">
